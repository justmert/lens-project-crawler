...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("lens-protocol-ec-crawler.log"),  # Write logs to this file
...
LENS_PROTOCOL_TOML_URL = "https://raw.githubusercontent.com/electric-capital/crypto-ecosystems/master/data/ecosystems/l/lens-protocol.toml.toml"
GITHUB_USERNAME = os.getenv("GITHUB_USERNAME")  # Your GitHub username
BASE_REPO = "electric-capital/crypto-ecosystems"
BRANCH_NAME = f"lens-protocol-{uuid.uuid4()}"
...
SEARCH_QUERIES = [
    {"filename": "package.json", "keyword": "lens-protocol/react-web"},
    {"filename": "package-lock.json", "keyword": "lens-protocol/react-web"},
    {"filename": "yarn.lock", "keyword": "lens-protocol/react-web"},
    {"filename": "package.json", "keyword": "lens-protocol/client"},
    {"filename": "package-lock.json", "keyword": "lens-protocol/client"},
    {"filename": "yarn.lock", "keyword": "lens-protocol/client"},
    {"filename": "package.json", "keyword": "lens-protocol/wagmi"},
    {"filename": "package-lock.json", "keyword": "lens-protocol/wagmi"},
    {"filename": "yarn.lock", "keyword": "lens-protocol/wagmi"},
    {"filename": "package.json", "keyword": "lens-protocol/metadata"},
    {"filename": "package-lock.json", "keyword": "lens-protocol/metadata"},
    {"filename": "yarn.lock", "keyword": "lens-protocol/metadata"},
    {"extension": "sol", "keyword": "LensModule.sol"},
]
...
def fetch_current_projects():
    """Fetch the current list of projects from lens-protocol.toml."""
    logging.info("Fetching current projects from lens-protocol.toml.")
    response = requests.get(LENS_PROTOCOL_TOML_URL)
...
def search_new_repositories():
    """Search for new LENS-related repositories on GitHub."""
...
def push_changes(updated_toml, new_repos):
    ...
    try:
        ...
        contents = forked_repo.get_contents(
            "data/ecosystems/l/lens-protocol.toml", ref=BRANCH_NAME
        )
        forked_repo.update_file(
            contents.path,
            "Update Lens Protocol project list",
            updated_toml,
            contents.sha,
            branch=BRANCH_NAME,
        )
        ...
        pr = forked_repo.create_pull(
            title="Update Lens Protocol Project List",
            body=pr_body,
            head=BRANCH_NAME,
            base="master",
        )
